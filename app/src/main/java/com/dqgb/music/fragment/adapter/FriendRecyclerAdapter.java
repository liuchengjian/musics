package com.dqgb.music.fragment.adapter;
...
import com.dqgb.lib_video.VideoAdContext;
import com.dqgb.music.R;
import com.dqgb.music.fragment.recyclerview.MultiImageViewLayout;
import com.dqgb.music.fragment.recyclerview.MultiItemTypeAdapter;
import com.dqgb.music.fragment.recyclerview.base.ItemViewDelegate;
import com.dqgb.music.fragment.recyclerview.base.ViewHolder;
import com.dqgb.music.model.FriendBodyValue;
...
public class FriendRecyclerAdapter extends MultiItemTypeAdapter {
     ...
     * 图片类型item
     */
    public class MusicItemDelegate implements ItemViewDelegate<FriendBodyValue> {
        @Override

...
/**
 * Author by lchj,
 * Email 627107345 @qq.com, Date on 2019/10/25.
 * 负责视频播放，暂停，事件触发
 */
...
public class CustomVideoView extends RelativeLayout implements View.OnClickListener, MediaPlayer.OnPreparedListener,
     ...
     */
    private String mUrl;
    private boolean isMute;//是否禁音
    private int mScreenWidth, mDestationHeight;
    private boolean canPlay = true;
    private boolean mIsRealPause;//真正暂停，用户点击暂停
    ...
    public CustomVideoView(Context context) {
        ...
        initData();
        initView();
        registerBroadcastReceiver();//初始化监听锁屏事件的广播接收器
    }
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (mediaPlayer != null) {
            ...
            resume();
            if (listener != null) {
                listener.onAdVideoLoadSuccess();//告诉外面播放成功
            }
        }
    }
